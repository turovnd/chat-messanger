...
class ChatServer implements Runnable {
    ...
    private DataStore dataStore = new DataStore( true);

    private ChatServer(int port) {
        try {
            JsonTransformer transformer = new JsonTransformer();
            get("/hello", "demo/json", (req, res) -> "Hello World",
                    transformer);
            get("/send", "demo/json", (req, res) -> {
                        try {
                            String message = req.queryParams("message");
                            String senderName = req.queryParams("senderName");
                            dataStore.add(message, senderName);
                    ...
                    transformer);
            get("/fetchAllMessages", "demo/json", (req, res) -> {
                        try {
                            return dataStore.get();
                        } catch (Exception e) {
                            e.printStackTrace();
